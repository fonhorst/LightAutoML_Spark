...
from sparklightautoml.spark.dataset.roles import NumericVectorOrArrayRole
from sparklightautoml.spark.mlwriters import CommonPickleMLReadable, CommonPickleMLWritable, SparkLabelEncoderTransformerMLReadable, SparkLabelEncoderTransformerMLWritable
from sparklightautoml.spark.transformers.base import SparkBaseEstimator, SparkBaseTransformer
from lightautoml.transformers.categorical import categorical_check, encoding_check, oof_task_check, \
    multiclass_task_check

from sparklightautoml.spark.transformers.scala_wrappers.laml_string_indexer import LAMLStringIndexer, LAMLStringIndexerModel
...
class SparkLabelEncoderEstimator(SparkBaseEstimator, TypesHelper):
    """
    Spark label encoder estimator. Returns :class:`~sparklightautoml.spark.transformers.categorical.SparkLabelEncoderTransformer`.
    """
...
class SparkOrdinalEncoderEstimator(SparkLabelEncoderEstimator):
    """
    Spark ordinal encoder estimator. Returns :class:`~sparklightautoml.spark.transformers.categorical.SparkOrdinalEncoderTransformer`.
    """
...
class SparkFreqEncoderEstimator(SparkLabelEncoderEstimator):
    """
    Calculates frequency in train data and produces :class:`~sparklightautoml.spark.transformers.categorical.SparkFreqEncoderTransformer` instance.
    """
...
class SparkCatIntersectionsHelper:
    """Helper class for :class:`~sparklightautoml.spark.transformers.categorical.SparkCatIntersectionsEstimator` and
    :class:`~sparklightautoml.spark.transformers.categorical.SparkCatIntersectionsTransformer`.
    """
...
class SparkCatIntersectionsEstimator(SparkCatIntersectionsHelper, SparkLabelEncoderEstimator):
    """
    Combines categorical features and fits :class:`~sparklightautoml.spark.transformers.categorical.SparkLabelEncoderEstimator`.
    Returns :class:`~sparklightautoml.spark.transformers.categorical.SparkCatIntersectionsTransformer`.
    """
...
class SparkTargetEncoderEstimator(SparkBaseEstimator):
    """
    Spark target encoder estimator. Returns :class:`~sparklightautoml.spark.transformers.categorical.SparkTargetEncoderTransformer`.
    """
...
class SparkMulticlassTargetEncoderEstimator(SparkBaseEstimator):
    """
    Spark multiclass target encoder estimator. Returns :class:`~sparklightautoml.spark.transformers.categorical.SparkMultiTargetEncoderTransformer`.
    """
