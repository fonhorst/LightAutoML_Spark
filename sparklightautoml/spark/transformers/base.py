...
from sparklightautoml.spark.mlwriters import CommonPickleMLReadable, CommonPickleMLWritable
from sparklightautoml.spark.utils import log_exec_time, SparkDataFrame
...
class SparkColumnsAndRoles(HasInputCols, HasOutputCols, HasInputRoles, HasOutputRoles):
    """
    Helper and base class for :class:`~sparklightautoml.spark.transformers.base.SparkBaseTransformer` and 
    :class:`~sparklightautoml.spark.transformers.base.SparkBaseEstimator`.
    """
...
class SparkBaseEstimator(Estimator, SparkColumnsAndRoles, ABC):
    """
    Base class for estimators from `sparklightautoml.spark.transformers`.
    """
...
class SparkBaseTransformer(Transformer, SparkColumnsAndRoles, ABC):
    """
    Base class for transformers from `sparklightautoml.spark.transformers`.
    """
    _fname_prefix = ""
