...
from sparklightautoml.spark.transformers.base import ObsoleteSparkTransformer, SparkBaseTransformer
...
class SparkDatetimeHelper:
    """
    Helper class for :class:`~sparklightautoml.spark.transformers.datetime.SparkTimeToNumTransformer`,    
    :class:`~sparklightautoml.spark.transformers.datetime.SparkBaseDiffTransformer` and
    :class:`~sparklightautoml.spark.transformers.datetime.SparkDateSeasonsTransformer`
    """
