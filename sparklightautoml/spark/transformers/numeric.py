...
from sparklightautoml.spark.transformers.base import SparkBaseEstimator, SparkBaseTransformer, ObsoleteSparkTransformer
...
class SparkNaNFlagsEstimator(SparkBaseEstimator):
    """Estimator that calculate nan rate for input columns and build :class:`~sparklightautoml.spark.transformers.numeric.SparkNaNFlagsTransformer`.
    """
