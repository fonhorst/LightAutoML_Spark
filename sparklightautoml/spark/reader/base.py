...
from sparklightautoml.spark.reader.guess_roles import get_numeric_roles_stat, get_category_roles_stat, get_null_scores
...
class SparkReaderHelper:
    """Helper class that provide some methods for :class:`~sparklightautoml.spark.reader.base.SparkToSparkReader` and
    :class:`~sparklightautoml.spark.reader.base.SparkToSparkReaderTransformer`.
    """
