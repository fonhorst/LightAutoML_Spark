...
class SparkLabelEncoderTransformerMLReader(MLReader):
    ...
    def load(self, path):
        ...
        from sparklightautoml.spark.transformers.scala_wrappers.laml_string_indexer import LAMLStringIndexerModel
...
class ONNXModelWrapperMLReader(MLWriter):
    ...
    def load(self, path):
        ...
        from sparklightautoml.spark.ml_algo.boost_lgbm import ONNXModelWrapper
...
class LightGBMModelWrapperMLReader(MLReader):
    ...
    def load(self, path):
        ...
        from sparklightautoml.spark.ml_algo.boost_lgbm import LightGBMModelWrapper
