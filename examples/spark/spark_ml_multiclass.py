...
with spark_session(master="local[4]") as spark:
    ...
    print(f"LAMA oof: {lama_oof_metric}. "
          f"LAMA-on-spark oof: {lama_on_spark_oof_metric}. "
          f"Spark oof: {spark_based_oof_metric}")
    print(f"LAMA test: {lama_test_metric}. "
          f"LAMA-on-spark test: {lama_on_spark_test_metric}. "
          f"Spark test: {spark_based_test_metric}")
