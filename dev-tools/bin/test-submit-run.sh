...
spark-submit \
  ...
  --conf 'spark.kubernetes.driver.podTemplateFile=/home/admin/LightAutoML/dev-tools/config/spark-pod-driver-template.yaml' \
  --conf 'spark.kubernetes.executor.podTemplateFile=/home/admin/LightAutoML/dev-tools/config/spark-pod-exec-template.yaml' \
  ...
  local:///scripts/spark_used_cars.py
